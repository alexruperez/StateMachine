...
class StatefulViewControllerTests: XCTestCase {
    ...
    func testStartWithDisappeared() {
        XCTAssertNil(statefulViewController.stateMachine.current)
    ...
    func testWillAppear() {
        ...
        XCTAssertEqual((statefulViewController.stateMachine.current as? ViewControllerState)?.animated, false)
        ...
        XCTAssertEqual((statefulViewController.stateMachine.current as? ViewControllerState)?.animated, true)
    }
